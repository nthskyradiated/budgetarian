...
export const PROJECT_NAME_MIN_ERROR_MESSAGE = ` Field must be at least ${minNameLen} characters long `;
export const PROJECT_NAME_MAX_ERROR_MESSAGE = ` Field must be less than ${maxNameLen} characters long `;
