 ...
 */
const ACTIONS = {
	'verifyCode /auth/email-verification': `?/verifyCode`,
	'sendNewCode /auth/email-verification': `?/sendNewCode`,
...
export type KIT_ROUTES = {
	...
	ACTIONS: {
		'verifyCode /auth/email-verification': never;
		'sendNewCode /auth/email-verification': never;
		'logInUser /auth/login': never;
		'sendPasswordResetEmail /auth/login': never;
		'registerUser /auth/register': never;
